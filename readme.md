netcontrolz is a Python library built on top of the [zen](http://zen.networkdynamics.org/) network library and provides methods to probe the control properties of complex networks.
